...
public class PurchaseOrder_TC_23 {
	...
	public static void main(String[] args) throws IOException {
		...
		WebElement text = driver.findElement(By.xpath("//a[text()='Marketing Group']"));
		String txt=text.getText();
		String expectedText="Marketing Group";
		...
		{
			System.out.println("Order  not Assigned to Marketing Group");
		}
	}
